package com.anas.lostfound.feature_lostfound.presentation.new_found.components
...
@Composable
fun FoundItemForm(viewModel: FoundItemViewModel, mapViewModel: MapViewModel, isOwner: Boolean) {
    ...
    val galleryLauncher = rememberLauncherForActivityResult(
        ...
        viewModel.onEvent(FoundItemEvent.SelectedImage(imageUri))
    }
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        Box(
            ...
            if(imageUri.isNotEmpty()) {
                ...
                contentDescription = "ContentDescriptions.GallerySelect",
                tint = Color.Black,
        ...
        Column(
            ...
            Column(
                ...
                CustomInputTextField(
                    ...
                    onValueChange = {
                        title = it
                        viewModel.onEvent(FoundItemEvent.EnteredTitle(it)) },
                    modifier = Modifier
                        .padding(10.dp)
                        .fillMaxWidth()
                        .background(
            ...
            Column(
                ...
                CustomInputTextField(
                    ...
                    onValueChange = {
                        description = it
                        viewModel.onEvent(FoundItemEvent.EnteredDescription(it)) },
                    modifier = Modifier
                        .padding(10.dp)
                        .fillMaxWidth()
                        .background(
            ...
            Row(
                ...
                CustomInputTextField(
                    ...
                    onValueChange = {
                        contact = it
                        viewModel.onEvent(FoundItemEvent.EnteredContact(it)) },
                    modifier = Modifier
                        .padding(10.dp)
                        .fillMaxWidth()
                        .background(
            ...
            Row(
                ...
                FilterDropDown(
                    ...
                    onItemSelected = {
                        selectedCategory = it
                        viewModel.onEvent(FoundItemEvent.SelectedCategory(it))
                    },
                    modifier = Modifier
                        .fillMaxWidth(0.6f)
                        .padding(5.dp)
